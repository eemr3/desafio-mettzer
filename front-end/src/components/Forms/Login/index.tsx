...
import ImageLogin from '../../../../public/images/img-login-screen.svg';
            ...
            <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
              <form onSubmit={formik.handleSubmit}>
                  ...
                  <Input.Root className="mb-6">
                    ...
                    <Input.Password>
                      <Input.CustomInput
                        ...
                        sm:leading-6"
                      />
                      <EyeSlashIcon className="h-6 w-6 absolute z-20 mr-2 cursor-pointer text-gray-800" />
                    </Input.Password>
                ...
                <div className="text-center lg:text-left">
                  <button
                    type="submit"
                    className="relative mt-4 bg-blue-600 hover:bg-blue-700 px-4 w-40 py-3 text-white uppercase rounded text-xs tracking-wider"
                  >
                    <span className="absolute inset-y-0 left-0 flex items-center pl-3 mr-2">
                      <LockClosedIcon
