...
import { CREATE_USE } from '../../../lib/mutation';
import { useRouter } from 'next/router';

export default function SignUp() {
  const router = useRouter();
  const [createUser] = useMutation(CREATE_USE);
  ...
  return (
    <Form.Root>
      <Form.Ilutration image="/images/img-signup-screen.svg" />
      <Form.Container>
        <form onSubmit={formik.handleSubmit}>
          <div className="flex flex-row items-center justify-center lg:justify-start mb-10">
            <p className="mb-0 mr-4 text-3xl font-medium">Vamos criar uma conta?</p>
          </div>
          ...
          <div className="mb-6 flex items-center justify-between">
            <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
              ...
              />
              <label
                className="inline-block pl-[0.15rem] hover:cursor-pointer text-blue-600"
