            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <h1 className="text-white text-xl font-semibold">Lista de Artigos</h1>
                </div>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    ...
                    rounded-full bg-blue-400 text-sm focus:outline-none focus:ring-2 
                    text-white focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-800`}
                    >
                      <span className="sr-only">Open user menu</span>
                      <LetterAvatar name={user?.fullName} />
                    </Menu.Button>
                  </div>
                  <Transition
                    as={Fragment}
                  ...
                  >
                    ...
                    >
                      ...
                      <Menu.Item>
                        <button
                          className="bg-blue-500 flex items-center gap-x-1 px-4 py-2 text-sm 
                          text-white"
                          onClick={logout}
                        >
